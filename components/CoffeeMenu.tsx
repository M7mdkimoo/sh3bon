...
const blends = [
  {
    id: 'sh3bon',
    name: 'شع بن (الأصالة)',
    composition: 'حبشي + برازيلي ريو + هندي بلانتيشن + هندي روبستا',
    ...
    prices: [
      { weight: '125جم', plain: 80, spiced: 95 },
      { weight: '250جم', plain: 150, spiced: 175 },
      { weight: '500جم', plain: 300, spiced: 350 },
    ],
  ...
  },
  {
    ...
    composition: 'كولومبي + برازيلي + هندوراس',
    description: 'لعشاق النكهات الواضحة والتركيز العالي. كولومبي فاخر مع لمسات الجواتيمالي لتعطيك مذاقاً ناعماً وحموضة متزنة.',
    prices: [
      { weight: '125جم', plain: 85, spiced: 100 },
      { weight: '250جم', plain: 160, spiced: 185 },
      { weight: '500جم', plain: 320, spiced: 370 },
    ],
    accent: '#D4AF37', // Unified Gold
    textColor: 'black',
  ...
  },
  {
    ...
    composition: 'جواتيمالي + برازيلي سانتوس + هندي بلانتيشن + هندي ميسور',
    description: 'القمة في عالم القهوة. بنسب سرية لضمان أعلى جودة وسر الصنعة. طعم حاد، ريحة جبارة، وتأثير لا يضاهى في الصحصحة.',
    prices: [
      { weight: '125جم', plain: 110, spiced: 125 },
      { weight: '250جم', plain: 210, spiced: 235 },
      { weight: '500جم', plain: 420, spiced: 470 },
    ],
    accent: '#D4AF37', // Unified Gold
    textColor: 'black',
              ...
              <div className="p-8 flex-grow flex flex-col">
                ...
                <div className="mb-6 bg-[#D4AF37]/5 border border-[#D4AF37]/20 p-3 rounded-lg">
                  <p className="text-gray-300 text-xs leading-relaxed">
                    <span className="text-[#D4AF37] font-bold">💡 ضمان التحويجة:</span> بنستخدم <span className="text-white font-bold">حبهان، جوزة الطيب، زر ورد، وقرنفل</span>. التحويجة عندنا مش مجرد إضافات؛ إحنا بنطحن ونعبي طازج وقت الطلب عشان تضمن الريحة والطعم الفريش.
                  </p>
                </div>
